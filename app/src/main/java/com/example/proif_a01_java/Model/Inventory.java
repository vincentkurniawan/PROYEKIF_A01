...
public class Inventory {
    ...
    public Inventory () {
        ...
        products[29] = new Product("XIAOMI NOTE 10",Product.CATEGORY_PHONE,100,Product.CONDITION_90);
        products[30] = new Product("SAMSUNG GALAXY S10", Product.CATEGORY_PHONE,500,Product.CONDITION_NEW);
